    ...
    <div class="card bg-base-100 shadow-md rounded-2xl border border-slate-200">
        <div class="card-body p-8">
            ...
            <form action="{{ route('obat.update', $obat->id) }}" method="POST">
                ...
                {{-- Grid Pertama: Nama Obat & Kemasan --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <div class="flex items-center border-2 rounded-lg px-4 py-2 focus-within:border-blue-500 bg-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" value="{{ old('stok', $obat->stok) }}" min="0" step="1"
                            placeholder="Masukkan jumlah stok..." class="w-full px-4 py-2 border-2 rounded-lg
                                      focus:border-blue-500 focus:outline-none
